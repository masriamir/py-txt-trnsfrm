...
class TestTransformAPI:
    ...
    def test_transform_with_sample_data(self, client):
        ...
        for text_key, text_value in sample_texts.items():
            ...
            data = {"text": text_value, "transformation": "alternate_case"}
    ...
    def test_transform_edge_cases(self, client):
        ...
        for _case_name, case_text in edge_cases.items():
            data = {"text": case_text, "transformation": "alternate_case"}
            response = client.post(
                "/transform", data=json.dumps(data), content_type="application/json"
            )
    ...
    def test_transform_with_mocked_transformer(self, mock_transform, client):
        ...
        data = {"text": "test text", "transformation": "alternate_case"}
        response = client.post(
            "/transform", data=json.dumps(data), content_type="application/json"
        )
    ...
    def test_transform_property_based(self, client, text):
        ...
        data = {"text": text, "transformation": "alternate_case"}
        response = client.post(
            "/transform", data=json.dumps(data), content_type="application/json"
        )
    ...
    def test_transform_with_faker_data(self, client):
        ...
        data = {"text": fake_text, "transformation": "alternate_case"}
        response = client.post(
            "/transform", data=json.dumps(data), content_type="application/json"
        )
